...
st.markdown(f''' <style> .stApp {{
    background-image: url("https://superblog.supercdn.cloud/site_cuid_clmabmzfq6832153upb93yfvlta/images/motor-insurance-driveu-smc-1715064991448-compressed.png");
